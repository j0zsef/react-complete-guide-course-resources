...
export default function WelcomePage() {
    ...
    const opacityCityImage = useTransform(scrollY, [0, 200, 300, 500], [1, 0.5, 0.5, 0]);
    const yHero = useTransform(scrollY, [0, 200], [0, -150]);
    const opacityHeroImage = useTransform(scrollY, [0, 300, 500], [1, 1, 0]);
    ...
    return (
        <>
            <header id="welcome-header">
                ...
                <motion.img
                    style={{opacity: opacityCityImage, y: yCity}}
                    src={cityImg}
                    alt="A city skyline touched by sunlight"
                    id="city-image"
                />
                <motion.img
                    style={{opacity: opacityHeroImage, y: yHero}}
                    src={heroImg}
